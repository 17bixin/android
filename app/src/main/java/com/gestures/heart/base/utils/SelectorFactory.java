...
/**
 *  选择器工厂
 *   Shape |  ColorSelector  | GeneralSelector
 */
public class SelectorFactory {
    ...
    public static final class GeneralSelector {
        ...
        private boolean hasSetActivatedDrawable = false;
        ...
        public GeneralSelector setDefaultDrawable(Drawable drawable) {
            ...
            if(!hasSetActivatedDrawable)
                mActivatedDrawable = drawable;
            return this;
        }
        ...
        public GeneralSelector setActivatedDrawable(Drawable drawable) {
            mActivatedDrawable = drawable;
            hasSetActivatedDrawable = true;
            return this;
        }
        ...
        public StateListDrawable create() {
            ...
            if(hasSetActivatedDrawable)
                selector.addState(new int[]{android.R.attr.state_activated}, mActivatedDrawable);
        ...
        //overload
        public GeneralSelector setActivatedDrawable(Context context, @DrawableRes int drawableRes) {
            return setActivatedDrawable(ContextCompat.getDrawable(context, drawableRes));
        }
