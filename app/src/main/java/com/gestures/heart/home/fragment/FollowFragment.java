...
import com.gestures.heart.home.adapter.FollowAdapter;
...
public class FollowFragment extends LazyLoadFragment {
    ...
    protected void initView() {
        ...
        adapter = new FollowAdapter(mList);
    ...
    private void loadMore(final boolean isRefresh) {
        ...
        OkHttpUtil.getDefault(FollowFragment.this).doAsync(HttpInfo.Builder().setRequestType(RequestType.GET)
            ...
            public void onSuccess(HttpInfo info) throws IOException {
                ...
                ArrayList<FollowBean> itemList = new ArrayList<>(PAGE_SIZE);
                for (int i = 0; i < 8; i++) {
                    String url;
                    if (i % 2 == 0)
                    ...
                    itemList.add(new FollowBean(url, "11w", "1.8km", i));
                }
    ...
    private void setData(boolean isRefresh, List<FollowBean> data) {
