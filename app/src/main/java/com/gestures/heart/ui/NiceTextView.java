...
import com.alens.utils.DisplayUtil;
...
public class NiceTextView extends RelativeLayout {
    ...
    public NiceTextView(Context context, AttributeSet attrs) {
        ...
        defaultLinePadding = DisplayUtil.dip2px(context, 16);
        defaultPadding = DisplayUtil.dip2px(context, 16);
        defaultSize = DisplayUtil.sp2px(context, 14);
        getAttr(attrs);
        initLayout();
    ...
    private void initTopLine(int lineMargin) {
        ...
        topLineParams = new LayoutParams(LayoutParams.MATCH_PARENT, DisplayUtil.dip2px(mContext, 1));
    ...
    private void initBottomLine(int lineMargin) {
        ...
        bottomLineParams = new LayoutParams(LayoutParams.MATCH_PARENT, DisplayUtil.dip2px(mContext, 1));
    ...
    private void initCenterBaseLine() {
        ...
        centerBaseLineParams = new LayoutParams(LayoutParams.MATCH_PARENT, DisplayUtil.dip2px(mContext, 10));
     ...
     * @return 返回值
     */
    public NiceTextView setCbCheckedAlens(boolean checked, Drawable drawable) {
        isChecked = checked;
